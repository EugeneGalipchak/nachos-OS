...
private:
    ...
    int maleBool;             //boolean to check male
    int femaleBool;           //boolean to check female
    int matchBool;            //boolean to check match
 
    int malePres;
    int femalePres;
    int matchPres;

    Condition *maleWait;      //condition for male 
    Condition *femaleWait;    //condition for female
    Condition *matchWait;     //condition for match
};
...
public:
    ...
    void Send(int message);      // send message
...
private:
    ...
    int copied;             //boolean to check Send()
    int receiveBool;        //boolean to check it receive has started
    int buff;               //buffer used to store message

    int check;              //using for assert

    Condition *sendWait;    // wait condition variable 
    Condition *receiveWait; // signal condition variable
};
